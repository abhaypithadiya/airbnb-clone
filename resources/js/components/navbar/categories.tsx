        ...
        <div className="shadow-md">
            <Container>
                <div className="flex flex-row items-center gap-4">
                    ...
                    <div className="flex cursor-pointer flex-row items-center gap-3 rounded-xl border-[1px] border-neutral-200 p-4 transition hover:border-neutral-700 hover:bg-neutral-100 md:px-4 md:py-3">
                        <LuSettings2 />
